...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/throbbing-bonus-4563
```

A live public deployment of this template is available at [https://throbbing-bonus-4563.templates.workers.dev](https://throbbing-bonus-4563.templates.workers.dev)
